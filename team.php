      ...
      <div class="row">
        <div class="col-xs-12">
         <nav class="navbar navbar-default navbar-header" role="navigation">
            <a href="index.php"><img src="images/home/a10-white.png" width="150" alt="Image" class="logo"></a>
...
<section class="about-us section-space">
  <div class="container">
    <div class="row service-main">
	  ...
	  <div class="col-md-12">
          <h2 class="main-title text-center">Team</h2>
        </div>
	  
	
    <div class="col-md-8 col-md-offset-2" >  
     		
	  <div class="col-sm-6 space-bottom text-center ">
			<div class="col-sm-5" style="float: none; margin: auto;">
            <img src="images/anto.png" class="img-responsive" />
            </div>
     ...
     <div class="col-sm-6 space-bottom text-center ">
			<div class="col-sm-5" style="float: none; margin: auto;">
            <img src="images/selvaprakash.png" class="img-responsive" />
            </div>
            <div class="col-sm-12" style="font-family:  sans-serif;">
