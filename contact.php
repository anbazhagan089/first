...
<link href="css/masterslider.maineed8.html?ver=2.7.2" type="text/css" media="all" rel="stylesheet"/>
...
<!-- end header -->
<section class="contact section-space" style="background: #FAFAFA;">
...
<div class="contact-icon">
		<i class="icon_map"></i>
		<h3>ADDRESS</h3>
		<p>Flat No.7, AnuKrupa Apartments,<br>
Plot No. 7/1, 2nd Cross,<br>
Muniyappa Layout,<br>
Wind Tunnel Road,<br>
MurugeshPalya,<br>
Bangalore - 560017
...
<script src="http://maps.googleapis.com/maps/api/js?key=AIzaSyBzmX14gJdU5qnnkxxWTR2XjcndXdjFVPA" type="text/javascript"></script> 
<script>
var markers = [
            ...
            "description": 'A10 digital <br/><a href="http://www.a10digital.com/" style="color:#1ECD97; font-weight:700;">Get it now</a>'
        }
	];
	/* Google Maps API */
