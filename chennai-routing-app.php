...
<header class="inner">
 	<div class="content  overlay">
    		<div class="centered">
          <h1>Works</h1>
          <h5>Our projects, created with passion and perfection</h5>
          </div>
           <!-- end centered -->
          </div>
          <!-- end content -->
...
<!-- end header -->
<section class="works-detail section-space">
  <div class="container">
    <div class="row">
      <div class="col-md-8 col-md-offset-2 text-center">
        <h2 class="main-title">Chennai Routing King</h2>
        
      </div>
      <!-- end col-8 -->
      <div class="col-md-8 col-md-offset-2 text-justify">
        <ul class="works-detail-carousel">
          <li><img src="images/works/phamplet.jpg" alt="Image"></li>
        </ul>
        <!-- end ul -->
        <h3>Desription ;</h3>
        <p> The outdoor creative for Chennai Route King, a smartphone app based in Chennai..
 .. </p>
