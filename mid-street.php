  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 col-md-offset-2 text-center">
        <h2 class="main-title">Mid Street</h2>
        
      </div>
      <!-- end col-8 -->
      <div class="col-md-8 col-md-offset-2 text-justify">
        <ul class="works-detail-carousel">
          <li><img src="images/works/Coffee_bag.jpg" alt="Image"></li>
        </ul>
        <!-- end ul -->
        <h3>Desription ;</h3>
        <p>The coffee bag created for Mid Street, a coffee shop based in Chennai.. </p>
