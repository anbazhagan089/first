  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 col-md-offset-2 text-center">
        <h2 class="main-title"> Towel factory</h2>
        
      </div>
      <!-- end col-8 -->
      <div class="col-md-8 col-md-offset-2 text-justify">
        <ul class="works-detail-carousel">
          <li><img src="images/works/towel-factory-logo.jpg" alt="Image"></li>
        </ul>
        <!-- end ul -->
        <h3>Desription ;</h3>
        <p> The logo created for Towel Factory, a textile group based in Madurai.
 .. </p>
