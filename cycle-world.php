  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 col-md-offset-2 text-center">
        <h2 class="main-title">Cycle world</h2>
        
      </div>
      <!-- end col-8 -->
      <div class="col-md-8 col-md-offset-2 text-justify">
        <ul class="works-detail-carousel">
          <li><img src="images/works/cycle.jpg" alt="Image"></li>
        </ul>
        <!-- end ul -->
        <h3>Desription ;</h3>
        <p> The logo and banner created for  Cycleworld, a popular bicycle store in Bangalore. </p>
