...
<section class="about-us section-space">
  <div class="container">
    <div class="row">
	  ...
	  <div class="col-md-12">
          <h2 class="main-title text-center">SEO Services</h2>
        </div>
...
<div class="container-full">
    <div class="row">
	  ...
	  <div class="col-md-6 no-padding">
			<img src="images/service/SEO.jpg" class="img-responsive" />
	  </div>
	  ...
	  <div class="col-md-6 ">
			...
			<div class="vc_empty_space" style="height: 30px"><span class="vc_empty_space_inner"></span></div>
				  ...
				  <h2 style="text-align: left;color: #ffffff;"><strong>SEO</strong></h2>
				  <h6 style="color: #ffffff;">&nbsp;&nbsp;</h6>
				  <span style="color: #ffffff; font-size: 16px; line-height: 22.6px;"> Search Engine Optimization is one of the most crucial aspects of digital marketing, today. We have the best minds in business when it comes to SEO who will help your website climb the top of the ladder when it comes to search engines.
				  </span>
